...
namespace SmartPOSWebApp.Controllers
{
    public class OrdersController : Controller
    {
        private readonly SmartPOSContext _context;

        public OrdersController(SmartPOSContext context)
        {
            _context = context;
        }
        ...
        {
            var smartPOSContext = _context.Order.Include(o => o.Customer);
            return View(await smartPOSContext.ToListAsync());
        }
